...
public class ShowClass {
    ...
    public static void main (String[] args) throws ClassNotFoundException {
        print_class(Class.forName(args[0]));
    }
    ...
    public static void print_class (Class<?> c) {
        ...
        for (Constructor<?> constructor : constructors) {
            print_method_or_constructor(constructor);
        }
        ...
        for (Method method : methods) {
            print_method_or_constructor(method);
        }
    ...
    /**
     * Print the modifiers, return type, name, parameter types and exception type of a method or
     * constructor. Note the use of the Member interface to allow this method to work with both
